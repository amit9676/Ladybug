...
class InformationDisplayClass:
    def __init__(self, location: (int, int), mainActions, window: (int,int), information: (int,int,int)):
        ...
        object_spacing = self.__rect.width // 4
        ...
        self.__display_flame_pos = (self.__rect.centerx, vertical_center)
        self.__display_rocket_pos = (self.__rect.right - object_spacing, vertical_center)
